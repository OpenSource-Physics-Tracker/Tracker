...
public class TActions {
  ...
  public static Map<String, AbstractAction> getActions(final TrackerPanel trackerPanel) {
    ...
    // open
    Icon icon = new ResizableIcon("/images/open.gif"); //$NON-NLS-1$
    ...
    // openBrowser
    icon = new ResizableIcon("/images/open_catalog.gif"); //$NON-NLS-1$
    ...
    // save current tab
    icon = new ResizableIcon("/images/save.gif"); //$NON-NLS-1$
    ...
    // save zip resource
    icon = new ResizableIcon("/images/save_zip.gif"); //$NON-NLS-1$
    ...
    // axesVisible
    icon = new ResizableIcon("/images/axes.gif"); //$NON-NLS-1$

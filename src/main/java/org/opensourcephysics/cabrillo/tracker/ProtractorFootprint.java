...
public class ProtractorFootprint implements Footprint, Cloneable {
    ...
    private static final ProtractorFootprint CIRCLE_3, CIRCLE_5, CIRCLE_3_BOLD, CIRCLE_5_BOLD;

    protected static int arcRadius = 24;
    private static final Collection<ProtractorFootprint> footprints = new HashSet<>();
    ...
    private static final Arc2D arc =
            new Arc2D.Double(-arcRadius, -arcRadius, 2 * arcRadius, 2 * arcRadius, 0, 0, Arc2D.OPEN);

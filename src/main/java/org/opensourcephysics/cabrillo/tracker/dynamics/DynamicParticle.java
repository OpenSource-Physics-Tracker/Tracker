 ...
 */
package org.opensourcephysics.cabrillo.tracker.dynamics;
...
public class DynamicParticle extends ParticleModel implements ODE {
    ...
    public DynamicSystem system;
    protected Point2D[] points;
    protected HashMap<Integer, double[]> frameStates = new HashMap<>();
    public ModelBooster modelBooster = new ModelBooster();
     ...
     */
    public void setBooster(PointMass booster) {
     ...
     */
    public boolean isBoostedBy(PointMass target) {

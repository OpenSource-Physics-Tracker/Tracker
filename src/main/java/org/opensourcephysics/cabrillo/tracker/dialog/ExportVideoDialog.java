...
import org.opensourcephysics.cabrillo.tracker.component.TView;
...
public class ExportVideoDialog extends JDialog {
    ...
    public static ExportVideoDialog videoExporter; // singleton
    ...
    public HashMap<Object, JComponent> views;

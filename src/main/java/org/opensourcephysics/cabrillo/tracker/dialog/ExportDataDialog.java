...
public class ExportDataDialog extends JDialog {
    ...
    public static ExportDataDialog dataExporter; // singleton

    // instance fields
    public TrackerPanel trackerPanel;
    public JButton saveAsButton, closeButton;
    public JComponent tablePanel, delimiterPanel, contentPanel, formatPanel;
    public JComboBox<String> formatDropdown;
    public JComboBox delimiterDropdown;
    public JComboBox<String> tableDropdown;
    public JComboBox<String> contentDropdown;
    public HashMap<Object, DataTable> tables;
    public HashMap<DataTable, String> trackNames;

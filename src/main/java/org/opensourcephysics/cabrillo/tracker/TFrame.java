...
//          menubar.refresh();
  ...
  private void createDefaultMenuBar() {
    ...
    if( org.opensourcephysics.display.OSPRuntime.applet == null) {
      ...
      // open file item
      Icon icon = new ImageIcon("/home/arthur/IdeaProjects/Tracker/src/main/resources/images/open.gif"); //$NON-NLS-1$
      ...
      fileMenu.addSeparator();
      // openBrowser item
      icon = new ImageIcon("/home/arthur/IdeaProjects/Tracker/src/main/resources/images/open_catalog.gif"); //$NON-NLS-1$

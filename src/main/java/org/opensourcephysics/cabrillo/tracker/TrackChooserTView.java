...
public abstract class TrackChooserTView extends JPanel implements TView {
    ...
    /**
     * Maps track to its trackView
     */
    protected Map<TTrack, TrackView> trackViews = new HashMap<>();

    /**
     * Maps dropdown items to track
     */
    protected Map<Object, TTrack> tracks = new HashMap<>();

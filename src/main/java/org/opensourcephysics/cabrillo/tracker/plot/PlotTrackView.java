 ...
 */
package org.opensourcephysics.cabrillo.tracker.plot;
...
public class PlotTrackView extends TrackView {
    ...
    public TrackPlottingPanel[] plots = new TrackPlottingPanel[3];
     ...
     */
    public void syncXAxesTo(TrackPlottingPanel plot) {
     ...
     */
    public void syncYAxes(TrackPlottingPanel... plots) {

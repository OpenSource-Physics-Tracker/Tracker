...
public class TFrame extends OSPFrame implements PropertyChangeListener {
    ...
    public JTextPane notesTextPane;
    public Action saveNotesAction;
    public JButton cancelNotesDialogButton, closeNotesDialogButton;
    public JCheckBox displayWhenLoadedCheckbox;
    public JDialog notesDialog;
    protected JDialog helpDialog;
    public LibraryBrowser libraryBrowser;
    protected Launcher helpLauncher;
    protected TrackerPanel prevPanel;
    public double defaultRightDivider = 0.7;
    ...
    public ArrayList<String> loadedFiles = new ArrayList<>();
    public boolean anglesInRadians = Tracker.isRadians;
    public File tabsetFile; // used when saving tabsets
    ...
    public boolean alwaysListenToClipboard;
...
//  array is {mainView, views, panes, toolbar, menubar, trackbar};
     ...
     */
    public JSplitPane getSplitPane(TrackerPanel trackerPanel, int paneIndex) {
        JSplitPane[] panes = getSplitPanes(trackerPanel);
        if (paneIndex < panes.length) {
...
//    checkMemory();
     ...
     * @param panel the tracker panel
     */
    public void showTrackControl(final TrackerPanel panel) {
     ...
     * @param panel the tracker panel
     */
    public void showNotes(final TrackerPanel panel) {

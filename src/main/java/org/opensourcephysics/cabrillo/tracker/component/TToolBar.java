...
import org.opensourcephysics.cabrillo.tracker.component.PageTView.TabView;
...
public class TToolBar extends JToolBar implements PropertyChangeListener {
    ...
    public static int[] trailLengths = {1, 4, 15, 0};
    protected static int[] stretchValues = {1, 2, 3, 4, 6, 8, 12, 16, 24, 32};

    public static String[] trailLengthNames = {"none", "short", "long", "full"};
    ...
    public int trailLength = trailLengths[Tracker.trailLengthIndex];
    ...
    public JButton trackControlButton;
    public JButton autotrackerButton;
    ...
    public CalibrationButton calibrationButton;
    ...
    public boolean notYetCalibrated = true;
     ...
     */
    public void refresh(final boolean refreshTrackProperties) {
     ...
     */
    public class CalibrationButton extends TButton

...
import org.opensourcephysics.cabrillo.tracker.data.track.DataTrackTool;
import org.opensourcephysics.cabrillo.tracker.deploy.TrackerStarter;
import org.opensourcephysics.cabrillo.tracker.dialog.ExportZipDialog;
import org.opensourcephysics.cabrillo.tracker.dialog.PrefsDialog;
import org.opensourcephysics.cabrillo.tracker.track.TrackDataBuilder;
...
public class Tracker {
    ...
    public static final String ALPHA = TeXParser.parseTeX("$\\alpha");
    public static final String DEGREES = "°";
    static final String SQUARED = "\u00b2";
    static final String DOT = "\u00b7";
    public static final Level DEFAULT_LOG_LEVEL = ConsoleLevel.OUT_CONSOLE;
    ...
    public static String newerVersion; // new version available if non-null
    static boolean checkedForNewerVersion = false; // true if checked for new version
    public static String trackerWebsite = "physlets.org/tracker";
    static String author = "Douglas Brown";
    static String osp = "Open Source Physics";
    public static AbstractAction aboutFFMPegAction, aboutThreadsAction;
    public static Action aboutTrackerAction, readmeAction;
    public static Action aboutJavaAction, startLogAction, trackerPrefsAction;
    private static Tracker sharedTracker;
    static String readmeFileName = "tracker_README.txt";
    public static JDialog readmeDialog, startLogDialog, trackerPrefsDialog;
    ...
    public static Cursor zoomInCursor, zoomOutCursor, grabCursor;
    public static boolean showHints = true;
    public static boolean startupHintShown;
    static String pdfHelpPath = "/tracker_help.pdf";
    public static JButton pdfHelpButton;
    public static final ArrayList<String> recentFiles = new ArrayList<>();
    public static int minimumMemorySize = 32;
    public static int requestedMemorySize = -1, originalMemoryRequest = 0;
    public static long lastMillisChecked;
    public static int maxFontLevel = 6;
    public static Locale[] locales;
    public static Object[][] incompleteLocales;
    static Locale defaultLocale;
    public static ArrayList<String> checkForUpgradeChoices;
    public static Map<String, Integer> checkForUpgradeIntervals;
    public static Collection<String> dataFunctionControlStrings = new HashSet<>();
    static Collection<String> initialAutoloadSearchPaths = new TreeSet<>();
    public static Map<String, ArrayList<XMLControl>> dataFunctionControls = new TreeMap<>();
    ...
    public static Level preferredLogLevel = DEFAULT_LOG_LEVEL;
    public static boolean showHintsByDefault = true;
    public static int recentFilesSize = 6;
    public static int preferredMemorySize = -1;
    public static String lookAndFeel, preferredLocale, preferredDecimalSeparator, additionalDecimalSeparators;
    public static String preferredJRE, preferredTrackerJar, preferredPointMassFootprint;
    public static int checkForUpgradeInterval = 0;
    public static int preferredFontLevel = 0, preferredFontLevelPlus = 0;
    public static boolean isRadians, isVideoFast;
    public static boolean warnFFMPegError = true, warnNoVideoEngine = true;
    public static boolean warnVariableDuration = true;
    public static String[] prelaunchExecutables = new String[0];
    public static Map<String, String[]> autoloadMap = new TreeMap<>();
    public static String[] preferredAutoloadSearchPaths;
    public static boolean markAtCurrentFrame = true;
    public static boolean scrubMouseWheel, centerCalibrationStick, enableAutofill, showGaps, hideLabels;
    public static int trailLengthIndex = TToolBar.trailLengths.length - 2;
...
//________________________________  static methods ____________________________
     ...
     */
    public static void setDefaultConfig(Set<String> config) {
        if (defaultConfig == null)
     ...
     */
    public static void setPreferredLocale(String localeName) {
        if (localeName == null) {
...
//         determine if this is tracker.jar (Tracker main class)
        ...
        try {
            ...
            isTracker = mainclass.toString().endsWith("org.opensourcephysics.cabrillo.tracker.tracker.Tracker");
        } catch (Exception e) {
//            e.printStackTrace();
        }
...
//    warnNoVideoEngine = false; // for PLATO
     ...
     */
    public static void addRecent(String filename, boolean atEnd) {
     ...
     */
    public static void setRecentSize(int max) {
        max = Math.min(max, 12);

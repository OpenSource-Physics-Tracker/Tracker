...
import org.opensourcephysics.cabrillo.tracker.dialog.MonitorDialog;
...
public class TrackerIO extends VideoIO {
    ...
    public static FileFilter zipFileFilter, trkFileFilter, trzFileFilter;
    ...
    public static String delimiter = defaultDelimiter;
    ...
    public static boolean loadInSeparateThread = true;
    public static Set<MonitorDialog> monitors = new HashSet<>();
    public static double defaultBadFrameTolerance = 0.2;
    public static boolean dataCopiedToClipboard;

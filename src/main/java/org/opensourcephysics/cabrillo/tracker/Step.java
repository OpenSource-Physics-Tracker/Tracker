...
public abstract class Step implements Cloneable {
     ...
     * Third param : no fractional metrics
     */
    ...
    /**
     * Invalid until drawn except for point mass
     */
    protected boolean valid;

    /**
     * Tracker panel to Mark
     */
    protected Map<TrackerPanel, Mark> marks = new HashMap<>();

    /**
     * Array index of default TPoint
     */
    protected int defaultIndex = 0;

    /**
     * True if visible in plots, tables
     */

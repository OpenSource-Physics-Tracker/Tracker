...
public class AutoTracker implements Trackable, PropertyChangeListener {
    ...
    private static final int defaultEvolveRate = AutoTrackerOptions.MAX_EVOLVE_RATE / 5;
    ...
    private static final Footprint target_footprint = PointShapeFootprint.getFootprint("Footprint.BoldCrosshair"); //$NON-NLS-1$
    private static final Footprint inactive_target_footprint = PointShapeFootprint.getFootprint("Footprint.Crosshair"); //$NON-NLS-1$
    private static final Footprint corner_footprint = PointShapeFootprint.getFootprint("Footprint.SolidSquare"); //$NON-NLS-1$
...
//____________________ inner TPoint classes ______________________
    ...
    protected class Wizard extends JDialog
        ...
        protected void createGUI() {
            ...
            SpinnerModel model = new SpinnerNumberModel(defaultEvolveRate, 0, AutoTrackerOptions.MAX_EVOLVE_RATE, AutoTrackerOptions.MAX_EVOLVE_RATE / 20);

...
public class PencilCaption extends InteractiveTextLine {
    ...
    static {
        ImageIcon icon = new ImageIcon(Tracker.class.getResource("/images/hand_cursor.gif")); //$NON-NLS-1$

        handCursor = GUIUtils.createCustomCursor(icon.getImage(),
                new Point(5, 0), "Hand", Cursor.DEFAULT_CURSOR); //$NON-NLS-1$
